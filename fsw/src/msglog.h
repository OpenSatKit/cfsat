...
#define MSGLOG_STOP_LOG_CMD_DATA_LEN      CMDMGR_NO_PARAM_CMD_DATA_LEN

#define MSGLOG_START_PLAYBK_CMD_DATA_LEN  CMDMGR_NO_PARAM_CMD_DATA_LEN
#define MSGLOG_STOP_PLAYBK_CMD_DATA_LEN   CMDMGR_NO_PARAM_CMD_DATA_LEN

#define MSGLOG_RUN_CHILD_CMD_LEN          CMDMGR_NO_PARAM_CMD_LEN
#define MSGLOG_RUN_CHILD_CMD_DATA_LEN     CMDMGR_NO_PARAM_CMD_DATA_LEN
