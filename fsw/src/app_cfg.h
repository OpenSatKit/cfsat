...
#define CFG_OSK_C_DEMO_SEND_HK_TOPICID     OSK_C_DEMO_SEND_HK_TOPICID
#define CFG_OSK_C_DEMO_HK_TLM_TOPICID      OSK_C_DEMO_HK_TLM_TOPICID
#define CFG_OSK_C_DEMO_PLAYBK_TLM_TOPICID  OSK_C_DEMO_PLAYBK_TLM_TOPICID
...
#define APP_CONFIG(XX) \
   ...
   XX(OSK_C_DEMO_SEND_HK_TOPICID,uint32) \
   XX(OSK_C_DEMO_HK_TLM_TOPICID,uint32) \
   XX(OSK_C_DEMO_PLAYBK_TLM_TOPICID,uint32) \
   XX(CMD_PIPE_NAME,char*) \
   XX(CMD_PIPE_DEPTH,uint32) \
